...
namespace FYProject
{
    public class BuiltinDataComponent : GameFrameworkComponent
    {
        ...
        {
            if (m_BuildInfoTextAsset == null || m_BuildInfoTextAsset.text.IsNullOrEmpty())
            {
        ...
        {
            if (m_DefaultDictionaryTextAsset == null || m_DefaultDictionaryTextAsset.text.IsNullOrEmpty())
            {
